...
namespace Shared
{
    public static class ProcessHelper
    {
        ...
        public static string RunAndReadOutput(string path, string args = NoArgs) => RunAsync(path, args, false, true).GetAwaiter().GetResult();
        public static async Task<string> RunAndReadOutputAsync(string path, string args = NoArgs) => await RunAsync(path, args, false, true);
